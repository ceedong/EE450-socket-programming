...
while(1)
{count++;
if(count == 1){printf("The Server OR start receiving lines from the edge server for OR computation.The computation results are:\n");}
int num11;
...
or_result = binary1 | binary2; //or binary1,binary2,get the or_result.

//printf("%d\n",or_result);//testing purpose.
...
printf("%s or %s = %s\n",string1,string2,string3);//print the result message 
char *cc;
cc = strchr(string,'#');
if(cc){
